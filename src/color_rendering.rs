...
pub fn ray_color(r: &Ray) -> Color {
    ...
    //eprint!("t = {}", t);
    Color::new(1.0, 1.0, 1.0).mult(1.0 - t) + Color::new(0.1, 0.3, 1.0).mult(t)
}
...
pub fn write_ppm(width: u16, height: u16, max_value: u8, origin: Vec3, lower_left_corner: Vec3, horizontal_axe: Vec3, vertical_axe: Vec3) {
    ...
    for j in (0..height).rev() {
        ...
        for i in 0..width {
            ...
            let r: Ray = Ray::new(origin, lower_left_corner + horizontal_axe.mult(u) + vertical_axe.mult(v) - origin);
